  ...
  const experiences = [
    {
      ...
      description: "Working on ML-based applications and research tasks.",
      current: true,
    },
    {
      role: "Web Development Intern",
      company: "Edubot Station Pvt. Ltd.",
      period: "Dec 2024 – Mar 2025",
      description: "Created multiple screens and UI components for an LMS platform.",
      current: false,
    },
    {
    ...
    },
    {
      ...
      period: "May – Jun 2024",
      description: "Developed a QR code-based food delivery app for seamless orders.",
      current: false,
    },
  ];

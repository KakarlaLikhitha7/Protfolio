      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center text-center animate-fade-in">
          ...
          <p className="text-xl md:text-2xl mb-6 text-gradient font-semibold">
            AI & ML Enthusiast | Web Designer | Innovator
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <Button
              size="lg"
              className="bg-primary hover:bg-primary/90 text-primary-foreground glow-teal transition-all duration-300"
